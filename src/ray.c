...
/*   Updated: 2017/10/26 20:02:32 by fjanoty          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
return (0);
	dir = vec3_normalise(vec3_sub(to, from));
	obj = item->obj + self;
	...
	if (((solus.x >= 0 ) && !is_light_right_way(nrm_now, nrm1, dir))
		|| (solus.y >= 0 && !is_light_right_way(nrm_now, nrm2, dir)))
		return (1);
	return (0);
}
